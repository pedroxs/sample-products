package com.pedroxs.products.config;

import com.pedroxs.products.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.pedroxs.products.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.pedroxs.products.repository.search")
